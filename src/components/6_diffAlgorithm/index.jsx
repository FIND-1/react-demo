...
* 什么是 diff 算法?
* 含义:
*  diff 算法是一种用于比较两个数据结构（通常是树形结构）之间差异的算法。
*  过程见图: ./diffAlgorithm.png
* */

// 代码实现vDom Fiber Diff 算法
// TODO: 需要熟悉 React 源码 , 了解完整的渲染流程
// 也可以参考: https://pomb.us/build-your-own-react/
const React = {
...
// const vdom = React.createElement('div', { id: 1 }, React.createElement('span', null, 'zs'));
...
render(React.createElement('div', { id: 'root' }, React.createElement('span', null, 'zs')), document.getElementById('root'));

setTimeout(() => {
    render(React.createElement('div', { id: 'root' }, React.createElement('p', null, '新元素')), document.getElementById('root'));
}, 2000)
